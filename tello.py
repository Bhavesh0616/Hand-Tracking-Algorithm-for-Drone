    ...
    try:
        while True:
            ...
            if results and results.multi_hand_landmarks:
                print("🖐 Hand detected!")  # Debugging: Confirm hand detection
                for hand_landmarks in results.multi_hand_landmarks:
                    ...
                    if smoothed_gesture == "Open" and not in_air:
                        ...
                        print(f"📍 Takeoff Altitude Recorded: {takeoff_altitude} cm")
                    
                    elif smoothed_gesture == "Open" and in_air:
                        print("🛑 Stabilizing at Takeoff Position")
                ...
                print("⚠️ No hand detected!")  # Debugging: If no hand is detected
